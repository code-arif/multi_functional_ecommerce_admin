<template>
  <div class="sb-root" :class="[sizeClass, { 'sb-root--full': fullWidth }]" ref="rootRef">
    ...
    <button
      ...
      class="sb-trigger"
      :class="{
        'sb-trigger--open': isOpen,
        'sb-trigger--placeholder': !selectedLabel,
        'sb-trigger--disabled': disabled
      }"
      :disabled="disabled"
    ...
    <transition name="sb-drop">
      <div v-if="isOpen" class="sb-dropdown" role="listbox" :aria-label="label || 'Select option'" @click.stop>
        ...
        <button
          ...
          class="sb-option"
          :class="{
            'sb-option--selected': modelValue === opt.value,
            'sb-option--focused': focusedIndex === idx,
            'sb-option--disabled': opt.disabled,
          }"
...
<style scoped>
/* ═══════════════════════════════════════════
   SELECTBOX — Fully Custom Dropdown
   ═══════════════════════════════════════════ */
...
.sb-option--selected.sb-option--focused {
