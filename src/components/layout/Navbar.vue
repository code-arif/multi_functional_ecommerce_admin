...
const pageRoutes = [
    ...
    { path: '/invoices/sales/create', title: 'New Sale Invoice' },
    { path: '/invoices/sales', title: 'Sale Invoices' },
    { path: '/invoices/purchases/create', title: 'New Purchase Invoice' },
    { path: '/invoices/purchases', title: 'Purchase Invoices' },
