...
.fade-leave-to {
...

    {
        ...
        message: 'New vendor has been registered.',
        isRead: false
    },
    {
        id: 4,
        title: 'New refund request',
        message: 'Refund request #REF-1234 has been received.',
        isRead: false
    },
    {
        id: 5,
        title: 'New coupon created',
        message: 'Coupon #COU-1234 has been created.',
        isRead: false
    },
    {
        id: 6,
        title: 'New brand created',
        message: 'Brand #BRA-1234 has been created.',
        isRead: false
    },
    {
        id: 7,
        title: 'New category created',
        message: 'Category #CAT-1234 has been created.',
        isRead: false
    },
    {
        id: 8,
        title: 'New product created',
        message: 'Product #PRO-1234 has been created.',
        isRead: false
    },
    {
        id: 9,
        title: 'New shop created',
        message: 'Shop #SHO-1234 has been created.',
        isRead: false
    },
    {
        id: 10,
        title: 'New transaction created',
        message: 'Transaction #TRA-1234 has been created.',
        isRead: false
    },
    {
        id: 11,
        title: 'New campaign created',
        message: 'Campaign #CAM-1234 has been created.',
        isRead: false
    },
    {
        id: 12,
        title: 'New flash sale created',
        message: 'Flash sale #FLA-1234 has been created.',
        isRead: false
    },
    {
        id: 13,
        title: 'New user created',
        message: 'User #USE-1234 has been created.',
        isRead: false
    },
    {
        id: 14,
        title: 'New cms page created',
        message: 'CMS page #CMS-1234 has been created.',
        isRead: false
    },
    {
        id: 15,
        title: 'New report created',
        message: 'Report #REP-1234 has been created.',
        isRead: false
    },
    {
        id: 16,
        title: 'New setting created',
        message: 'Setting #SET-1234 has been created.',
        isRead: false
    },
    {
        id: 17,
