      ...
      <template #default="{ item }">
        ...
        <td class="table-cell text-right">
          <div class="flex justify-end gap-1">
            <button @click="openForm(item)" class="p-1.5 rounded-lg text-blue-500 hover:bg-blue-50">
        ...
        <div class="relative bg-white rounded-2xl p-6 w-full max-w-lg animate-in"
          ...
          <form @submit.prevent="save" class="space-y-4">
            ...
            <div>
              ...
              <input type="file" accept="image/*" @change="e => thumbFile = e.target.files[0]" class="input"/>
            </div>
