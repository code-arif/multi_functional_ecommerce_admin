<template>
  <div class="space-y-6">
    ...
    <div class="grid grid-cols-1 sm:grid-cols-2 xl:grid-cols-4 gap-4">
      <StatCard label="Today's Revenue" :value="stats.today_sales" :icon="DollarSign" prefix="৳"
                iconBg="bg-green-100" iconColor="text-green-700"/>
      <StatCard label="Monthly Revenue" :value="stats.monthly_sales" :icon="ChartBar" prefix="৳"
                iconBg="bg-blue-100" iconColor="text-blue-700"/>
      <StatCard label="Total Orders" :value="stats.total_orders" :icon="ShoppingCart" iconBg="bg-purple-100"
                iconColor="text-purple-700"/>
      <StatCard label="Pending Orders" :value="stats.pending_orders" :icon="Clock" iconBg="bg-yellow-100"
                iconColor="text-yellow-700"/>
    </div>
    <div class="grid grid-cols-1 sm:grid-cols-2 xl:grid-cols-4 gap-4">
      <StatCard label="Total Customers" :value="stats.total_customers" :icon="Users" iconBg="bg-indigo-100"
                iconColor="text-indigo-700"/>
      <StatCard label="Active Products" :value="stats.total_products" :icon="ListIndentIncrease" iconBg="bg-teal-100"
                iconColor="text-teal-700"/>
      <StatCard label="Low Stock Items" :value="stats.low_stock_products" :icon="FileExclamationPoint"
                iconBg="bg-red-100" iconColor="text-red-700"/>
      <StatCard label="This Month Sales" :value="stats.revenue_this_month" :icon="Banknote" prefix="৳"
