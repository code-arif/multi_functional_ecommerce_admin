<template>
  <div>
    <PageHeader title="Review Reports" subtitle="Product review analytics and moderation data" />
...
import { StarIcon, CheckCircleIcon, ClockIcon, XCircleIcon } from '@heroicons/vue/24/outline'
