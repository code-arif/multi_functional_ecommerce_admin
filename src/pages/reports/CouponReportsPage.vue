<template>
  <div>
    <PageHeader title="Coupon Reports" subtitle="Coupon usage analytics and discount performance" />
...
import { TicketIcon, ArrowPathIcon, BanknotesIcon, PercentBadgeIcon } from '@heroicons/vue/24/outline'
