<template>
  <div>
    <PageHeader title="Affiliate Reports" subtitle="Affiliate marketing performance and commission data" />
...
import { LinkIcon, CursorArrowRaysIcon, ShoppingBagIcon, BanknotesIcon } from '@heroicons/vue/24/outline'
