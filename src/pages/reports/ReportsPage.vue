  ...
  <div>
    ...
    <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 mb-6">
      ...
      <div class="stat-card">
        ...
        <div>
          ...
          <p class="text-xl font-black text-gray-900">৳{{ totalRevenue.toLocaleString() }}</p>
        </div>
      </div>
      ...
      <div class="stat-card">
        ...
        <div>
          ...
          <p class="text-xl font-black text-gray-900">{{ totalOrders.toLocaleString() }}</p>
        </div>
      </div>
      ...
      <div class="stat-card">
        ...
        <div>
          ...
          <p class="text-xl font-black text-gray-900">৳{{ avgOrderValue.toLocaleString() }}</p>
        </div>
      </div>
      ...
      <div class="stat-card">
        ...
        <div>
          ...
          <p class="text-xl font-black text-gray-900">{{ totalNewCustomers }}</p>
        </div>
      </div>
    </div>
    ...
    <div class="card overflow-hidden">
      ...
      <table class="w-full">
        ...
        <tbody>
          <tr v-if="loadingTop">
            <td colspan="4" class="text-center py-8 text-gray-400 text-sm">Loading...</td>
          </tr>
