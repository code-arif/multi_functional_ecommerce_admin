<template>
  <div>
    <PageHeader title="Email Reports" subtitle="Email campaign delivery and engagement metrics" />
...
import { EnvelopeIcon, EyeIcon, CursorArrowRaysIcon, ExclamationTriangleIcon } from '@heroicons/vue/24/outline'
