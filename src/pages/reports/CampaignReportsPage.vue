<template>
  <div>
    <PageHeader title="Campaign Reports" subtitle="Marketing campaign performance and analytics" />
...
import { MegaphoneIcon, PlayIcon, EyeIcon, ShoppingBagIcon } from '@heroicons/vue/24/outline'
