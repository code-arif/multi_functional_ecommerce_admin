...
import {
    ...
    Radio, WrenchScrewdriver, ShoppingCart, Bell,
...
const navItems = [
    { to: '/admin/settings/general', label: 'General', icon: markRaw(Store) },
    ...
    { to: '/admin/settings/maintenance', label: 'Maintenance', icon: markRaw(WrenchScrewdriver) },
]
</script>
